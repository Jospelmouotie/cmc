            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-12 mb-4">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Liste des ordonnances pour ce patient" data-bs-toggle="modal" data-bs-target="#ordonanceAll">
                                <i class="fas fa-eye"></i> Ordonnances
                            </button>

                            <button type="button" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Liste des examens pour ce patient" data-bs-toggle="modal" data-bs-target="#biologieAll">
                                <i class="fas fa-eye"></i> Examens Biologiques
                            </button>

                            @can('anesthesiste', \App\Models\Patient::class)
                            <a href="{{ route('surveillance_rapproche.index', $patient->id) }}" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Surveillance rapprochée des paramètres">
                                <i class="fas fa-eye"></i> Surveillance Rapprochée
                            </a>
                            @endcan

                            @can('chirurgien', \App\Models\Patient::class)
                            <a href="{{ route('consultations.index_anesthesiste', $patient->id) }}" class="btn btn-primary w-100 mb-2 btn-action-fixed">
                            ...
                            <!-- <button type="button" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Liste des examens pour ce patient" data-bs-toggle="modal" data-bs-target="#imagerieAll" data-bs-whatever="@mdo">
                                <i class="fas fa-eye"></i> Examens Imageries
                            </button>
                            <a href="{{ route('examens.index') }}" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Détails surveillance post-aneshésiste">
                                <i class="fas fa-eye"></i> Résultats d'Examens
                            </a> -->

                            <!-- // End of Imagerie exams addition -->

                            <a href="{{ route('surveillance_post_anesthesise.index', $patient->id) }}" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Détails surveillance post-aneshésiste">
                                <i class="fas fa-eye"></i> Surveillance Post-Anesthésique
                            </a>

                            <button type="button" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Fiches d'intervention" data-bs-toggle="modal" data-bs-target="#FicheInterventionAll">
                                <i class="fas fa-eye"></i> Fiche d'Intervention
                            </button>

                            <a href="{{ route('dossiers.create', $patient->id) }}" class="btn btn-info w-100 mb-2 btn-action-fixed">
                            ...
                            @if($patient->consultations && $patient->consultations->isNotEmpty())
                                ...
                                <a class="btn btn-success w-100 mb-2 btn-action-fixed" title="Imprimer la lettre de sortie" href="{{ route('print.sortie', $patient->id) }}">
                                    <i class="fas fa-print"></i> Lettre De Consultation
                                </a>
                                <button type="button" class="btn btn-primary w-100 mb-2 btn-action-fixed" title="Liste de fiches pour ce patient" data-bs-toggle="modal" data-bs-target="#ficheSuiviAll">
