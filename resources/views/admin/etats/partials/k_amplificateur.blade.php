@if (explode('/', $devis['categorie'])[3] == 'AMPLIFICATEUR DE BRILLANCE')
    <tr>
    ...
    <tr>
        ...
        <td class="text-end">{{ explode('/', $devis['prix'])[3] }}</td>
    </tr>
@endif

@if (explode('/', $devis['categorie'])[4] == 'AMPLIFICATEUR DE BRILLANCE')
    <tr>
