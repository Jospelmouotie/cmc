...
@if (explode('/', $devis['categorie'])[30] == 'ANATHOMO-PATHOLOGIE')
    <tr>
...
@if (!empty(explode('/', $devis['categorie'])[32]))
@if (explode('/', $devis['categorie'])[31] == 'ANATHOMO-PATHOLOGIE')
    <tr>
...
@if (!empty(explode('/', $devis['categorie'])[32]))
@if (explode('/', $devis['categorie'])[32] == 'ANATHOMO-PATHOLOGIE')
    <tr>
...
@if (!empty(explode('/', $devis['categorie'])[32]))
@if (explode('/', $devis['categorie'])[33] == 'ANATHOMO-PATHOLOGIE')
    <tr>
...
@if (!empty(explode('/', $devis['categorie'])[32]))
@if (explode('/', $devis['categorie'])[34] == 'ANATHOMO-PATHOLOGIE')
    <tr>
...
@endif
@if (!empty(explode('/', $devis['categorie'])[32]))
@if (explode('/', $devis['categorie'])[35] == 'ANATHOMO-PATHOLOGIE')
    <tr>
...
@if (!empty(explode('/', $devis['categorie'])[32]))
@if (explode('/', $devis['categorie'])[36] == 'ANATHOMO-PATHOLOGIE')
    <tr>
